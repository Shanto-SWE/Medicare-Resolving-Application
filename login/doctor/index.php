    ...
    <body>
        <div class="main-wrapper account-wrapper">
            <div class="row">
                ...
                <div class="col-sm-4">
                    <h4 style="text-align: center"><a href="../admin/">Admin Portal</a>&emsp;||&emsp;<a href="../doctor/" style="color:orangered" class="active">Doctors Portal</a>&emsp;||&emsp;<a href="../pharmacy/" class="active">Pharmacy Panel</a></h4>
                </div>
            </div>

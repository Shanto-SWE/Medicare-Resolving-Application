...
if(isset($_SESSION['user_id'])){
    header('location:../../dashboard/pharmacy/index.php');
}
...
if (isset($_POST['login'])) {
    ...
    $result = $login->pharmacistLogin($_POST);
}
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <body>
        <div class="main-wrapper account-wrapper">
            <div class="row">
                ...
                <div class="col-sm-4">
                    <h4 style="text-align: center"><a href="../admin/">Admin Portal</a>&emsp;||&emsp;<a href="../doctor/" class="active">Doctors Portal</a>&emsp; ||&emsp;<a href="../pharmacy/"  style="color:orangered"  class="active">Pharmacy Panel</a></h4>
                </div>
            </div>

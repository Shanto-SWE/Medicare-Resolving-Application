...
if (isset($_POST['save'])) {
    $message = $server->stockAuthData($_POST);
}
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <body>
        ...
        <div class="main-wrapper">
            ...
            <div class="page-wrapper">
               ...
               <h4 class="page-title"><u>Stock's Authentication Data</u> &emsp;<?php echo $message ?> </h4>
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="POST" action="">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="exampleInputUsername2" name="drug_name" placeholder="Enter drug name"  >
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Category</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="exampleInputEmail2" name="category"  placeholder="Enter category" >
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="exampleInputMobile" class="col-sm-3 col-form-label">Description</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="exampleInputMobile" name="description"  placeholder="Enter description" >
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="exampleInputPassword2" class="col-sm-3 col-form-label">Company</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="exampleInputPassword2" name="company"  placeholder="Enter company name" >
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="exampleInputConfirmPassword2" class="col-sm-3 col-form-label">Supplier</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="exampleInputConfirmPassword2" name="supplier"  placeholder="Enter supplier name" >
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <input type="text" class="form-control" id="exampleInputConfirmPassword2" name="cost"  placeholder="Enter drug cost" >

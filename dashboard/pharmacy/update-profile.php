                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group form-focus">
                                            ...
                                            <input type="text" class="form-control floating" name = "username" value="<?php echo $row['user_name'] ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group form-focus">
                                            <label class="focus-label">Userid<span class="text-danger">*</span></label>
                                            <input type="text" class="form-control floating" name = "userid" value="<?php echo $row['user_id'] ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group form-focus">

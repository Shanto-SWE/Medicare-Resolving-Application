...
<div class="sidebar-inner slimscroll">
    <div id="sidebar-menu" class="sidebar-menu">
        <ul>
            ...
            <li class="submenu">
                <a href="#"><i class="fa fa-users"></i> <span>Pharmacists  </span> <span class="menu-arrow"></span></a>
                <ul style="display: none;">
                    <li><a href="add-pharmacist.php" class="<?php if($url =='add-pharmacist.php'){echo 'active';}?>">Create Pharmacist </a></li>
                    <li><a href="pharmacist.php" class="<?php if($url =='pharmacist.php' || $url =='pharmacist-profile.php'){echo 'active';}?>"">All Pharmacist </a></li>
                </ul>
            </li>
            <li class="submenu">
